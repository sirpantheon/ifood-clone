  ...
  return (
    <>
      <ScrollView style={{ padding: 10, flex: 1, backgroundColor: "#F0F8FF" }}>
        ...
        >
          <Text>
            Entrega em <Text style={{ fontWeight: "500" }}>35 - 40 mins</Text>
          </Text>
        </View>
        ...
        <View>
          ...
          <View>
            ...
            >
              ...
              >
                ...
                <Text>Adicione mais instruções de cozimento</Text>
              </View>
              <AntDesign name="right" size={20} color="black" />
            </View>
            ...
            >
              ...
              >
                <MaterialCommunityIcons
                  ...
                  color="black"
                />
                <Text>Não envie talheres com este pedido</Text>
              </View>
              <AntDesign name="right" size={20} color="black" />
            </View>
          </View>
          ...
          <View>
            ...
            >
              ...
              >
                <Text>Alimentando o Rio grande do sul - Doação</Text>
              ...
              >
                <Text style={{ color: "gray" }}>
                  Trabalhando para um Brasil livre de manutrição
                </Text>
                <Text>Rs 3</Text>
              </View>
            </View>
